...
describe('Integration Tests - Node.js Services', () => {
  ...
  describe('OSINT API Endpoints', () => {
    ...
    describe('Username Search', () => {
      it('should return 200 for valid username search', async () => {
        const endpoint = apiEndpoints.osint.username.replace('{username}', testData.validUsername);
      ...
      it('should return 400 for invalid username search', async () => {
        const endpoint = apiEndpoints.osint.username.replace('{username}', testData.invalidUsername);
        const res = await makeRequest('osint-framework', endpoint)
          .get(endpoint)
          .timeout(TEST_CONFIG.timeouts.request);
      ...
      it('should return 404 for nonexistent username', async () => {
        const endpoint = apiEndpoints.osint.username.replace('{username}', testData.nonexistentResource);
        const res = await makeRequest('osint-framework', endpoint)
          .get(endpoint)
          .timeout(TEST_CONFIG.timeouts.request);
    ...
    describe('Email Lookup', () => {
      it('should return 200 for valid email lookup', async () => {
        const endpoint = apiEndpoints.osint.email.replace('{email}', testData.validEmail);
        const res = await makeRequest('osint-framework', endpoint)
          .get(endpoint)
          .timeout(TEST_CONFIG.timeouts.request);
      ...
      it('should return 400 for invalid email lookup', async () => {
        const endpoint = apiEndpoints.osint.email.replace('{email}', testData.invalidEmail);
        const res = await makeRequest('osint-framework', endpoint)
          .get(endpoint)
          .timeout(TEST_CONFIG.timeouts.request);
    ...
    describe('Domain Information', () => {
      it('should return 200 for valid domain lookup', async () => {
        const endpoint = apiEndpoints.osint.domain.replace('{domain}', testData.validDomain);
        const res = await makeRequest('osint-framework', endpoint)
          .get(endpoint)
          .timeout(TEST_CONFIG.timeouts.request);
      ...
      it('should return 400 for invalid domain lookup', async () => {
        const endpoint = apiEndpoints.osint.domain.replace('{domain}', testData.invalidDomain);
        const res = await makeRequest('osint-framework', endpoint)
          .get(endpoint)
          .timeout(TEST_CONFIG.timeouts.request);
  ...
  describe('Facebook Messenger API', () => {
    ...
    describe('Message Management', () => {
      it('should set message successfully', async () => {
        const res = await makeRequest('facebook-messenger', apiEndpoints.facebook.setmessage)
      ...
      it('should get message successfully', async () => {
        const res = await makeRequest('facebook-messenger', apiEndpoints.facebook.getmessage)
      ...
      it('should create new message successfully', async () => {
        const res = await makeRequest('facebook-messenger', apiEndpoints.facebook.newmessage)
      ...
      it('should fail to send message without valid session', async () => {
        const res = await makeRequest('facebook-messenger', apiEndpoints.facebook.sendmessage)
    ...
    describe('Friends Management', () => {
      it('should get friends list with authentication', async () => {
        const res = await makeRequest('facebook-messenger', apiEndpoints.facebook.friends)
  ...
  describe('Security Tests', () => {
    ...
    it('should prevent SQL injection attacks', async () => {
      const endpoint = apiEndpoints.osint.username.replace('{username}', testData.sqlInjection);
      const res = await makeRequest('osint-framework', endpoint)
        .get(endpoint)
        .timeout(TEST_CONFIG.timeouts.request);
    ...
    it('should prevent XSS attacks', async () => {
      const endpoint = apiEndpoints.osint.username.replace('{username}', encodeURIComponent(testData.xssPayload));
      const res = await makeRequest('osint-framework', endpoint)
        .get(endpoint)
        .timeout(TEST_CONFIG.timeouts.request);
    ...
    it('should handle large input gracefully', async () => {
      const endpoint = apiEndpoints.osint.username.replace('{username}', testData.largeInput);
      const res = await makeRequest('osint-framework', endpoint)
        .get(endpoint)
        .timeout(TEST_CONFIG.timeouts.request);
    ...
    it('should handle special characters properly', async () => {
      const endpoint = apiEndpoints.osint.username.replace('{username}', encodeURIComponent(testData.specialChars));
      const res = await makeRequest('osint-framework', endpoint)
        .get(endpoint)
        .timeout(TEST_CONFIG.timeouts.request);
    ...
    it('should handle unicode input correctly', async () => {
      const endpoint = apiEndpoints.osint.username.replace('{username}', encodeURIComponent(testData.unicodeInput));
      const res = await makeRequest('osint-framework', endpoint)
        .get(endpoint)
        .timeout(TEST_CONFIG.timeouts.request);
  ...
  describe('Rate Limiting Tests', () => {
    ...
    it('should enforce rate limiting on OSINT endpoints', async () => {
      const endpoint = apiEndpoints.osint.username.replace('{username}', 'rate_limit_test');
