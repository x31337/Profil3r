...
@pytest.mark.asyncio
async def test_username_search_positive(api_endpoints, service_urls, http_client, test_data):
...
@pytest.mark.asyncio
async def test_username_search_negative(api_endpoints, service_urls, http_client, test_data):
...
@pytest.mark.asyncio
async def test_email_lookup_positive(api_endpoints, service_urls, http_client, test_data):
...
@pytest.mark.asyncio
async def test_email_lookup_negative(api_endpoints, service_urls, http_client, test_data):
...
@pytest.mark.asyncio
async def test_domain_information_positive(api_endpoints, service_urls, http_client, test_data):
...
@pytest.mark.asyncio
async def test_domain_information_negative(api_endpoints, service_urls, http_client, test_data):
...
@pytest.mark.asyncio
async def test_security_sql_injection(api_endpoints, service_urls, http_client, test_data):
