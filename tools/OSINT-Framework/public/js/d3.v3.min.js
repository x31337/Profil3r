d3 = (function() {
  ...
  function w(t, n) {
    const e = Math.pow(10, 3 * Math.abs(8 - n));
    return {
      scale:
        n > 8
          ? function(t) {
  ...
  function Q(t, n, e) {
    ...
    const r = pn((0.4124564 * t + 0.3575761 * n + 0.1804375 * e) / sa),
  ...
  function xn(t, n) {
    function e() {
      for (let e = -1; u > ++e; ) t[e](this, n);
    }
    function r() {
      for (let e = -1, r = n.apply(this, arguments); u > ++e; ) t[e](this, r);
    }
  ...
  function zn(t, n, e, r) {
    let u = t.__transition__ || (t.__transition__ = { active: 0, count: 0 }),
      a = u[e];
    if (!a) {
      const o = r.time;
      return (
  ...
  function In(t, n, e, r) {
    function u() {
      const u = Math.min(t.length, n.length) > 2 ? Gn : Jn,
        c = r ? X : Z;
  ...
  function Ve(t) {
    for (var n = t.source, e = t.target, r = Xe(n, e), u = [n]; n !== r; )
      ((n = n.parent), u.push(n));
    for (let i = u.length; e !== r; ) (u.splice(i, 0, e), (e = e.parent));
    return u;
  }
  function Ze(t) {
  ...
  function xr(t, n, e, r) {
    ...
    if (((t.x = n += r * t.x), (t.y = e += r * t.y), (t.r *= r), u))
      for (let i = -1, a = u.length; a > ++i; ) xr(u[i], n, e, r);
  }
  function _r(t, n, e) {
    let r = t.r + e.r,
      u = n.x - t.x,
  ...
  function Qr(t, n) {
    function e(t, n) {
      const e = Math.sqrt(i - 2 * u * Math.sin(n)) / u;
  ...
  function au(t, n) {
    const e = Xr(n);
    ((e[0] -= t), Kr(e));
    const r = Math.acos(Math.max(-1, Math.min(1, -e[1])));
    ...
    if (
      (t.forEach(function(t) {
        if (!(1 >= (n = t.length))) {
          ...
          if (Zr(i, a)) {
            e.lineStart();
            for (let o = 0; n > o; ++o) e.point((i = t[o])[0], i[1]);
  ...
  function bu(t, n, e) {
    const r = Ci.range(t, n - qi, e).concat(n);
    return function(t) {
  ...
  function Xu(t, n) {
    var e = {
      ...
      u = {
        bisect: function(t, n) {
          const e = { region: { l: t, r: n }, ep: { l: null, r: null } },
            r = n.x - t.x,
            u = n.y - t.y,
            i = r > 0 ? r : -r,
            a = u > 0 ? u : -u;
      ...
      i = {
        ...
        nextEvent: function(t) {
          for (let n = 0, e = i.list, r = e.length; r > n; ++n)
  ...
  function ti(t, n, e) {
    Yo.lastIndex = 0;
    const r = Yo.exec(n.substring(e));
    return r ? (e += r[0].length) : -1;
  }
  function ni(t, n, e) {
    Oo.lastIndex = 0;
    const r = Oo.exec(n.substring(e));
    return r ? (e += r[0].length) : -1;
  }
  function ei(t, n, e) {
    Vo.lastIndex = 0;
    const r = Vo.exec(n.substring(e));
    return r ? ((t.m = Zo.get(r[0].toLowerCase())), (e += r[0].length)) : -1;
  }
  function ri(t, n, e) {
    Uo.lastIndex = 0;
    const r = Uo.exec(n.substring(e));
  ...
  function oi(t, n, e) {
    Jo.lastIndex = 0;
    const r = Jo.exec(n.substring(e, e + 4));
    return r ? ((t.y = +r[0]), (e += r[0].length)) : -1;
  }
  function ci(t, n, e) {
    Jo.lastIndex = 0;
    const r = Jo.exec(n.substring(e, e + 2));
  ...
  function di(t, n, e) {
    Jo.lastIndex = 0;
    const r = Jo.exec(n.substring(e, e + 3));
    return r ? ((t.L = +r[0]), (e += r[0].length)) : -1;
  }
  function mi(t, n, e) {
    const r = Go.get(n.substring(e, (e += 2)).toLowerCase());
  ...
  function Ai(t) {
    const n = new Date(Date.UTC(t, 0, 1));
  ...
  try {
    ...
    const Oi = Fi.CSSStyleDeclaration.prototype,
      Yi = Oi.setProperty;
  ...
  (Ci.random = {
    ...
    logNormal: function() {
      const t = Ci.random.normal.apply(Ci, arguments);
      return function() {
        return Math.exp(t());
      };
    },
  ...
  const Bi = Ci.bisector(function(t) {
    return t;
  });
    ...
    return (
      ...
      (u.send = function(e, r, i) {
        if (
          ...
          for (const a in o) l.setRequestHeader(a, o[a]);
        return (
  ...
  (Ci.format = function(t) {
    ...
    return function(t) {
      if (g && t % 1) return '';
      let n = 0 > t || (0 === t && 0 > 1 / t) ? ((t = -t), '-') : u;
      if (0 > s) {
        const d = Ci.formatPrefix(t, l);
        ((t = d.scale(t)), (h = d.symbol));
      } else t *= s;
      ((t = f(t, l)), !a && c && (t = Wi(t)));
      let m = i.length + t.length + (p ? 0 : n.length),
  ...
  (Ci.transform = function(t) {
    const n = Li.createElementNS(Ci.ns.prefix.svg, 'g');
    return (Ci.transform = function(t) {
      n.setAttribute('transform', t);
      const e = n.transform.baseVal.consolidate();
  ...
  (ba.select = function(t) {
    ...
    for (let a = -1, o = this.length; o > ++a; ) {
      (i.push((n = [])), (n.parentNode = (r = this[a]).parentNode));
      for (let c = -1, l = r.length; l > ++c; )
        (u = r[c])
  ...
  (ba.selectAll = function(t) {
    ...
    for (let u = -1, i = this.length; i > ++u; )
      for (let a = this[u], o = -1, c = a.length; c > ++o; )
        (e = a[o]) &&
  ...
  (ba.filter = function(t) {
    ...
    for (let i = 0, a = this.length; a > i; i++) {
      (u.push((n = [])), (n.parentNode = (e = this[i]).parentNode));
      for (let o = 0, c = e.length; c > o; o++)
        (r = e[o]) && t.call(r, r.__data__, o) && n.push(r);
    }
    return mn(u);
  }),
  (ba.order = function() {
    for (let t = -1, n = this.length; n > ++t; )
  ...
  (ba.sort = function(t) {
    ...
    for (let n = -1, e = this.length; e > ++n; ) this[n].sort(t);
    return this.order();
  }),
  ...
  (ba.node = function() {
    for (let t = 0, n = this.length; n > t; t++)
      for (let e = this[t], r = 0, u = e.length; u > r; r++) {
        const i = e[r];
        if (i) return i;
      }
    return null;
  ...
  (ba.transition = function() {
    let t,
      ...
      u = Object.create(Ea);
    u.time = Date.now();
    for (let i = -1, a = this.length; a > ++i; ) {
      r.push((t = []));
      for (let o = this[i], c = -1, l = o.length; l > ++c; )
  ...
  (Sa.select = function(t) {
    ...
    for (let a = -1, o = this.length; o > ++a; ) {
      i.push((n = []));
      for (let c = this[a], l = -1, f = c.length; f > ++l; )
  ...
  (Sa.selectAll = function(t) {
    let n,
      ...
      o = [];
    'function' != typeof t && (t = yn(t));
    for (let c = -1, l = this.length; l > ++c; )
      for (let f = this[c], s = -1, h = f.length; h > ++s; )
        if ((r = f[s])) {
          ((i = r.__transition__[a]),
          (e = t.call(r, r.__data__, s)),
          o.push((n = [])));
          for (let g = -1, p = e.length; p > ++g; )
  ...
  (Sa.attrTween = function(t, n) {
    function e(t, e) {
      const r = n.call(this, t, e, this.getAttribute(u));
      return (
        r &&
          function(t) {
    ...
    function r(t, e) {
      const r = n.call(this, t, e, this.getAttributeNS(u.space, u.local));
      return (
        r &&
          function(t) {
  ...
  Ci.svg.brush = function() {
    ...
    function u() {
      function u() {
        const t = Ci.event.changedTouches;
    ...
    function t(t, u) {
      function i(t, n) {
        ...
        if (r && (a = r.length)) {
          ...
          Fr(t);
          const g = 0.5 * (f._tree.prelim + l._tree.prelim);
          n
  ...
  var ao = {
      ...
      FeatureCollection: function(t, n) {
        for (let e = t.features, r = -1, u = e.length; u > ++r; )
          Yr(e[r].geometry, n);
      }
    },
    oo = {
      ...
      MultiLineString: function(t, n) {
        for (let e = t.coordinates, r = -1, u = e.length; u > ++r; )
          Ur(e[r], n, 0);
      },
      ...
      GeometryCollection: function(t, n) {
        for (let e = t.geometries, r = -1, u = e.length; u > ++r; ) Yr(e[r], n);
      }
    };
  ...
  Ci.geo.circle = function() {
    function t() {
      const t = 'function' == typeof r ? r.apply(this, arguments) : r,
  ...
  ((Ci.geom.delaunay = function(t) {
    ...
    return (
      ...
      n.forEach(function(n, r) {
        ...
        for (let o = 0, c = n.length - 1; c > o; o++)
          e.push([u, n[o], n[o + 1]]);
      }),
      e
    );
  ...
  Ci.time.format = function(t) {
    ...
    return (
      (n.parse = function(n) {
        const e = { y: 1900, m: 0, d: 1, H: 0, M: 0, S: 0, L: 0 },
          r = Gu(e, t, n, 0);
  ...
  const Ko = Ci.time.format.utc('%Y-%m-%dT%H:%M:%S.%LZ');
  ((Ci.time.format.iso =
  ...
  (Ci.time.hour = Mi(
    function(t) {
      const n = t.getTimezoneOffset() / 60;
