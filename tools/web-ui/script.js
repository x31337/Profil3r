document.addEventListener('DOMContentLoaded', () => {
  ...
  const reportHistoryContainer = document.getElementById(
  ...
  if (reportForm) {
    reportForm.addEventListener('submit', async function(event) {
      ...
      submissionStatusDiv.innerHTML =
        '<p class="status-pending"><i class="fas fa-spinner fa-spin"></i> Submitting report, please wait...</p>';
  ...
  async function fetchReportHistory() {
    try {
      reportHistoryContainer.innerHTML =
        '<p class="status-pending">Loading report history...</p>';
      ...
      let historyHtml =
        '<table><thead><tr><th>ID</th><th>Target URL</th><th>Status</th><th>Justification</th><th>Evidence</th><th>Created At</th></tr></thead><tbody>';
