...
async function testLegacyInterface() {
  ...
  try {
    ...
    console.log(
      ...
      typeof autoBuild.dependencyManager.installDependencies === 'function'
    );
    console.log(
      '✅ builder.fullBuild:',
      typeof autoBuild.builder.fullBuild === 'function'
    );
    console.log(
      '✅ tester.runAllTests:',
      typeof autoBuild.tester.runAllTests === 'function'
    );
    console.log(
      '✅ deployer.deployChanges:',
      typeof autoBuild.deployer.deployChanges === 'function'
    );
    console.log(
      '✅ autoFixEngine.autoFixIssues:',
      typeof autoBuild.autoFixEngine.autoFixIssues === 'function'
    );
    console.log(
      '✅ serviceManager.startService:',
      typeof autoBuild.serviceManager.startService === 'function'
    );
    ...
    console.log(
      '✅ startWebServer:',
      typeof autoBuild.startWebServer === 'function'
    );
    console.log(
      '✅ startWebSocketServer:',
      typeof autoBuild.startWebSocketServer === 'function'
    );
    ...
    console.log(
      '✅ initFileWatchers:',
      typeof autoBuild.initFileWatchers === 'function'
    );
